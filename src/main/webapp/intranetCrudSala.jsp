...
<h4>Crud Sala</h4> <h4>Autor: Rivera oncoy Miguel </h4>
	
	
	
	<div class="row" style="margin-top: 5%">
			<div class="col-md-3">
				<label class="control-label" for="id_filtro">Número de Sala</label> 
			</div>	
			<div class="col-md-6">
	...
	<div class="row" style="margin-top: 4%">
			<table id="id_table" class="table table-bordered table-hover table-condensed" >
				<thead style='background-color:#fdff00; color:black'>
					<tr>
						<th>ID</th>
		...
		<div class="modal fade" id="id_div_modal_registra" >
			<div class="modal-dialog" style="width: 60%">
					...
					<div class="modal-header" >
						...
						<h4><span class="glyphicon glyphicon-ok-sign"></span> Registra Sala</h4>
					</div>
			                   		...
			                   		<div id="stepOne" class="panel-collapse collapse in">
			                   			...
			                   			<div class="panel-body">
			                                <div class="form-group" >
		                                        <label class="col-lg-3 control-label" for="id_reg_numero">Número de Sala</label>
		                                        <div class="col-lg-8">
			                   		...
			                   		<div id="stepOne" class="panel-collapse collapse in">
			                   			...
			                   			<div class="panel-body">
		                                    ...
		                                    <div class="form-group" >
		                                        ...
		                                        <div class="col-lg-8">
													<input class="form-control" id="id_act_numalumnos" name="numAlumnos" placeholder="Ingrese alumnos" type="number">
		                                        </div>
		                                    </div>
		                                    ...
		                                    <div class="form-group">
		                                        <div class="col-lg-12" align="center">
		                                        	<button type="button" style="width: 80px" id="id_btn_actualiza" class="btn btn-warning">Actualiza</button>
	...
	<script type="text/javascript">
		...
		function verFormularioActualiza(idSala, numero, piso, numAlumnos, recursos, estado, sede){
								...
								$("#id_div_modal_actualiza").modal("show");$("#idSala").val(idSala);
								$("#id_act_numero").val(numero);$("#id_act_piso").val(piso);
								$("#id_act_numalumnos").val(numAlumnos);$("#id_act_recursos").val(recursos);
								$("#id_act_estado").val(estado);$("#id_act_sede").val(sede);
		}
	
		$.getJSON("cargarSedes",{}, function (data){
			$.each(data, function(index, item){$("#id_reg_sede")
				.append("<option value='"+ item.idSede +"'>"+ item.nombre+"</option>");
				$("#id_act_sede").append
		        	...
		        	recursos : {  
		        		...
		        		validators : {
		                    ...
		                    stringLength: {
		                        min: 3,
		                        max: 30,
		                        message: 'Los recursos tienen de 2 a 30 caracteres'
		                    },
		        		}
		        	},
		        	estado : {
		...
		function limpiarFormulario(){	
			$('#id_reg_numero').val("");$('#id_reg_piso').val("");
			$('#id_reg_numalumnos').val(" ");$('#id_reg_recursos').val(" ");
			$('#id_reg_sede').val(" ");$('#id_act_numero').val("");
			$('#id_act_piso').val("");$('#id_act_numalumnos').val(" ");
			$('#id_act_recursos').val(" ");$('#id_act_estado').val(" ");
			$('#id_act_sede').val(" ");
		}
	</script>
